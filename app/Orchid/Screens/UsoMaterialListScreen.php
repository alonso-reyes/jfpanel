...
use App\Orchid\Layouts\UsoMaterialListLayout;
...
class UsoMaterialListScreen extends Screen
{
    /**
    ...
    public function commandBar(): iterable
    {
        return [
            ...
            Link::make('Agregar')
                ->icon('plus')
                ->route('platform.uso.material.edit')
        ];
    }
    ...
    public function delete(MaterialUso $uso)
    {
        $uso->delete();
    }
    ...
    public function excelImport(Request $request)
    {
        ...
        foreach ($rows as $key => $row) {
            ...
            // Valida repetidos
            $exists = MaterialUso::where('uso', $row[0])
